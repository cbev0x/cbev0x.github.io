...
## Initial Foothold
Since we know that the system is Windows I use a base64 encoded powershell reverse shell from [revshells](https://www.revshells.com/). Next, we can copy and paste that payload after the pipe and double URL encode it.
