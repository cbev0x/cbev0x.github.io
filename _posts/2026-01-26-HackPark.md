...
Now we can start looking at ways to escalate privileges other administrator. We can display the OS version using sysinfo in our meterpreter shell and use that to find any exploits using [Windows-Exploit-Suggester](https://github.com/GDSSecurity/Windows-Exploit-Suggester) or upload [WinPEAS](http://github.com/peass-ng/PEASS-ng/tree/master/winPEAS) like I did.
