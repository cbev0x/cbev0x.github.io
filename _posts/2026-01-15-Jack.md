...
![](../assets/img/2026-01-15/5.png)

![](../assets/img/2026-01-15/6.png)
...
Then I check the plugins available and find that ‘Hello Dolly’ is installed. We are able to alter this plugins PHP code to our reverse shell with the same method. Here is a good article on how this works.

![](../assets/img/2026-01-15/8.png)
